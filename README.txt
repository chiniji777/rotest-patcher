...
สำคัญสำหรับไอเทมเป็นแอปเปิ้ล/ภาพหาย: ชุดแพตช์ 1.3 ต้องใช้ Patcher โปรแกรม 1.2.0
ปิดเกมและ Patcher ก่อนแตก ZIP รุ่นใหม่ทับเฉพาะตัว Patcher แล้วเปิดกดตรวจ/อัปเดต
ไม่ต้องดาวน์โหลดเกมเต็มใหม่ ไม่เปลี่ยน ROTest.exe และไม่ทับ data.grf เดิม
แพตช์เพิ่ม rotest-finn-resources.grf และลงทะเบียนใน DATA.ini พร้อมข้อมูลอุปกรณ์ FINN
ถ้า DATA.ini มี GRF อื่นที่ไม่รู้จัก โปรแกรมจะหยุด ไม่ลบทิ้งหรือเขียนทับรายการนั้น
มีไฟล์สำรองและกู้คืนได้ ไม่เชื่อมกับ FINN จริงหรือบัญชีเงินจริง

ร้าน FINN ทดสอบที่ Morroc 166,100: อุปกรณ์ชุดแรก 13 ชิ้นจากคำอธิบายที่ระบุตัวเลขชัด
ชื่อขึ้น [FINN Test] ใช้ ID ตามต้นทาง ภาพตรงกับทรัพยากรที่มี และไม่อ้างว่าดาเมจเท่า FINN จริง
บางสูตร/ภาพไม่ครบจึงยังไม่ขาย ดู server/finn-wearables-recipes.json ส่วน held
ร้านอุปกรณ์มาตรฐาน: 163,100 แบ่งหมวด 1,959 ชิ้น ร้านการ์ด:169,100 รวม538ใบ
สร้างไฟล์ไอเทมตามลำดับ build-test-shops.mjs แล้ว build-finn-wearables.mjs เพื่อรักษาของเดิม
